...
class Product
{
    ...
    /**
     * Удаляем товар с нужным id
     * @param $id <p>id товара</p>
     * @return bool <p>Результат выполнение запроса</p>
     */
    ...
    /**
     * @param $id <p>id товара</p>
     * @param $options <p>Массив с информацией о товаре</p>
    ...
    public static function updateProductById($id, $options)
    {
        ...
        $sql = "UPDATE product SET "
            . "name = :name, code = :code, price = :price, category_id = :category_id, "
